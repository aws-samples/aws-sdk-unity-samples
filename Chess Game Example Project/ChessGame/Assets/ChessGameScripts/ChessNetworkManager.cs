    ...
    public class ChessNetworkManager : MonoBehaviour
    {
        ...
        private MobileAnalyticsManager AnalyticsManager
        {
            get
            {
                ...
                {
                    _analyticsManager = MobileAnalyticsManager.GetOrCreateInstance(Credentials, MobileAnalyticsRegion, MobileAnaylticsAppId);
                }
        ...
        {
            IDictionary<string, string> matchesStringDict = matchesDataset.GetAll();
