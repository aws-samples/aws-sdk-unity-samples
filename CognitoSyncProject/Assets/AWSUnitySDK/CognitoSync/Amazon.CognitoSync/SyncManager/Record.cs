...
namespace Amazon.CognitoSync.SyncManager
{
    public sealed class Record
    {
        ...
        /// </summary>
        /// <value>The key associated with the Recrod</value>
        public string Key
        {
        ...
        public Record(string key, string value, long syncCount, DateTime? lastModifiedDate, string lastModifiedBy, DateTime? deviceLastModifiedDate, bool modified)
        {
            ...
            this._deviceLastModifiedDate = deviceLastModifiedDate;
        ...
        public override string ToString()
        {
            return string.Format(
                "Key:[{0}], Value:[{1}], SyncCount:[{2}], LastModifiedDate:[{3}], LastModifiedBy:[{4}], DeviceLastModifiedDate:[{5}], Modified:[{6}]",
                Key, Value, SyncCount, LastModifiedDate, LastModifiedBy, DeviceLastModifiedDate, Modified);
        }
    }
}
