...
namespace Amazon.CognitoIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetOpenIdTokenForDeveloperIdentityRequestMarshaller : IMarshaller<IRequest, GetOpenIdTokenForDeveloperIdentityRequest> 
    {
        public IRequest Marshall(GetOpenIdTokenForDeveloperIdentityRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    writer.WritePropertyName("TokenDuration");
                    writer.Write(publicRequest.TokenDuration);
                }
