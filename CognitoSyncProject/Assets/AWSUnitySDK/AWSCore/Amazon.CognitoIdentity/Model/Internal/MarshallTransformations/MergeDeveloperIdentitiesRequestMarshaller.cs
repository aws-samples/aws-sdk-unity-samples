...
namespace Amazon.CognitoIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class MergeDeveloperIdentitiesRequestMarshaller : IMarshaller<IRequest, MergeDeveloperIdentitiesRequest> 
    {
        public IRequest Marshall(MergeDeveloperIdentitiesRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    writer.WritePropertyName("DestinationUserIdentifier");
                    writer.Write(publicRequest.DestinationUserIdentifier);
                }
                ...
                {
                    writer.WritePropertyName("SourceUserIdentifier");
                    writer.Write(publicRequest.SourceUserIdentifier);
                }
