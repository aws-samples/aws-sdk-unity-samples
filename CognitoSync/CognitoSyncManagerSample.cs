...
namespace AWSSDK.Examples
{
    ...
    public class CognitoSyncManagerSample : BaseSample
    {
        ...
        private CognitoSyncManager SyncManager
        {
            get
            {
                ...
                {
                    _syncManager = new CognitoSyncManager((CognitoAWSCredentials)GetCredentials(CredentialsType.Cognito), new AmazonCognitoSyncConfig { RegionEndpoint = RegionEndpoint.USEast1 });
                }
                return _syncManager;
            }
        }
        ...
        void OnGUI()
        {
            ...
            else if (GUILayout.Button("Refresh and Sync to CognitoSync Cloud", GUILayout.MinHeight(20), GUILayout.Width(Screen.width * 0.6f)))
            {
                ...
                SyncManager.RefreshDatasetMetadataAsync((result) =>
                {
